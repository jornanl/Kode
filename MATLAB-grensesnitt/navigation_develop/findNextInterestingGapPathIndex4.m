function [navDataNextIndex,gotoThroughThisGapX,gotoThroughThisGapY]...
    =findNextInterestingGapPathIndex4(myNavData,myNavDataLast,gaps)
...
if( size(interrestingGaps,1) > 0 )
    for m=1:1:size(interrestingGaps,1)
        ...
        distVect=(myNavDataLast(:,1)-interrestingGapMidPointX).^2+(myNavDataLast(:,2)-interrestingGapMidPointY).^2;
