%GET    Get method for differential drive simrobot object.
%   V = GET(R,'PropertyName') returns the value of the specified
%   property for the differential drive simrobot object R.
%
...
switch nargin,
  case 1,
    ...
    if (isa(r,'simrobotdd'))
      ...
      error('simulation/simrobotdd/get: Wrong argument type')
    end;
  case 2,
    r = varargin{1};
  ...
  otherwise
    error('simulation/simrobotdd/get: Wrong number of input arguments')
end