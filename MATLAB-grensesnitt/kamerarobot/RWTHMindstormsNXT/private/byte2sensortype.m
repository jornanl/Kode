...
sensorname = {'NO_SENSOR';'SWITCH';'TEMPERATURE';'REFLECTION';'ANGLE';'LIGHT_ACTIVE';'LIGHT_INACTIVE';'SOUND_DB';'SOUND_DBA';'CUSTOM';'LOWSPEED';'LOWSPEED_9V';'NO_OF_SENSOR_TYPES';};
