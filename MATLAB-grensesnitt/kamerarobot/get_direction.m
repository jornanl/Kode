function [rot_angel_motor rot_angel] = get_direction(lines,img_width, img_height)
...
%følger
%Grader =
%(Strek plassering i pixler * Kameraets Synsfelt i grader)/Bilde Bredde i
%pixler

%Added check to prevent crash when no line is present (Sigurd Hannaas 2011)
if(exist('line_number', 'var')),
    rot_angel = (lines(line_number).point2(1)* 61.48)/img_width;
else
    rot_angel = 0;
end
